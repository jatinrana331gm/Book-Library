        ...
        <div className="bg-amber-50 border border-amber-200 text-amber-800 px-4 py-3 rounded-lg text-sm">
          <div className="space-y-2">
            ...
            <ul className="text-sm list-disc list-inside space-y-1 ml-2">
              ...
              <li>Or use the redirect login method below</li>
            </ul>
            <button
              onClick={handleGoogleRedirectLogin}
              disabled={googleLoading}
              className="mt-3 inline-flex items-center px-3 py-2 border border-amber-300 shadow-sm text-sm leading-4 font-medium rounded-md text-amber-800 bg-amber-100 hover:bg-amber-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {googleLoading ? (
                <>
                  <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-amber-800" fill="none" viewBox="0 0 24 24">
